...
class SendSms():
    ...
    def Dsmartgo(self):    
        ...
        try:
            ...
            print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> dsmartgo.com.tr")
            self.adet += 1
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> kigili.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
    ...
    def PodyumPlus(self):    
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> podyumplus.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> shop.naosstars.com")
                self.adet += 1 
            else:
                raise
        except:
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Migros(self):
        try:
            ...
            if migros.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> rest.sanalmarket.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> a101.com.tr")
                self.adet += 1
            else:
                raise 
        except:
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> englishhome.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> sakasu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> rentiva.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Bineq(self):
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Link(self):
        try:
            ...
            if link.json()["detail"] == "Ok":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> consumer-auth.linkfleet.de")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Aydin(self):
        try:
            ...
            if (r.json()["result"]["status"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> apistore.apaydinsupermarket.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> loncamarket.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> odeme.dgnonline.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api.yaanimail.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> defacto.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> u.icq.net")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Boyner(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> boyner.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> watsons.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> app.buyursungelsin.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> osmgck.idealdata.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> pinarsumobileservice.yasar.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> suiste.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hayat(self):
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> hayatsu.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> apigw.ikinciyeni.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api.terrapizza.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def IpraGaz(self):
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Aygaz(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> ecommerce-memberapi.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mogazmobilapinew.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mobilapi.petrolofisi.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mobileapi.totalistasyonlari.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api.opet.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Dolap(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api-gateway.dolap.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Hey(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Isbike(self):
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "İşlem Başarılı":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> app.isbike.istanbul")
                self.adet += 1
            else:
                raise
        except:
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Ebebek(self):
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı İns @yasiomusumben --> api2.e-bebek.com")
                self.adet += 1
            else:
                raise
        except:
